...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Job No.  74016580000298Repair in Progre_0800c8'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/button_Submit to Release Signatory'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Confirm and Release to Signatory Please_a2cf03'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/img_Created_cursor-pointer'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Job No.  74016580000298Released to Sign_d146be'))
