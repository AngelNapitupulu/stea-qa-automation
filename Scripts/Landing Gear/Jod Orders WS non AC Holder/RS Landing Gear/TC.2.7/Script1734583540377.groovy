...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Back Assigned TechniciansRoleTechnician_2a2e55'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Job No.  78027880001030UPlanning in Pro_9996f0'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/button_Assign CRR'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Choose CRRCRR NumberComponent Descripti_cc6e74'))
