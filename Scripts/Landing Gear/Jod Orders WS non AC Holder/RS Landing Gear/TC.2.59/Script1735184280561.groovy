...
WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_Back Assigned TechniciansRoleTechnician_642c95'))
...
WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_Related Router No item selected  Form N_7a027e'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/button_Approve'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_Confirm and Approve CRR Form Please pla_7756bc'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/img_Created_cursor-pointer'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_CRR Form ProgressStatus Completed Compl_4fe670'))
