...
WebUI.click(findTestObject('WSnonAChold LG/RS/Page_Workchestra/input_Revision No_revision-rwws'))

WebUI.click(findTestObject('WSnonAChold LG/RS/Page_Workchestra/div_Revision No'))
