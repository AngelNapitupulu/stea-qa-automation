...
WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/button_Discard'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_Confirm Discard CRR Form Do you really _d1a293'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/button_Confirm'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/span_Discarded'))
