...
WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/td'))
...
WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_Confirm to amend CRR form Are you sure _89bb94'))

WebUI.setText(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/input_checkbox'), 'The data on the router is invalid')

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/button_Proceed'))
