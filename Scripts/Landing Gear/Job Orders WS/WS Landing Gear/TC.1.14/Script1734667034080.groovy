...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/label_CAA Singapore (AWI059)'))
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Error  Workstage Preliminary Inspection_6ade43'))
