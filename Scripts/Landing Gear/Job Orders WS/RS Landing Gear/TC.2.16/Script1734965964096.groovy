...
WebUI.click(findTestObject('WSnonAChold LG/RS/Page_Workchestra/div_Error  Index Page of Rework Worksheet is required'))

WebUI.click(findTestObject('WSnonAChold LG/RS/Page_Workchestra/div_Error'))
