...
WebUI.click(findTestObject('WSnonAChold LG/RS/Page_Workchestra/button_PDF_button-animated'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/a_Add Rework Worksheet'))

WebUI.click(findTestObject('Object Repository/WSnonAChold LG/RS/Page_Workchestra/div_Rework WorksheetRework Worksheets No.Re_1e77b2'))
