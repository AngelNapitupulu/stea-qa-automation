...
WebUI.navigateToUrl('https://workchestra-moonlay.southeastasia.cloudapp.azure.com:4200/eworkbag/job/525')
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/button_Sign workscope  CRR'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/img_Created_cursor-pointer'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Work DoneSSTUpdate WorkScope'))
