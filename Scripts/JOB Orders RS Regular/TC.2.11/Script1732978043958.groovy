...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/span_Update WorkScope'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/input_checkbox'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_MOD'))
