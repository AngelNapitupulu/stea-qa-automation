...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Back Assigned TechniciansRoleTechnician_36f819'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Job Details Work Stages Defect Rectific_a011ce'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/a_Tool Tagging'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Work Stages Defect Rectification Record_04ac9e'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/button_Approve Tool Tagging'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Approve and Sign Tool TaggingPlease, pl_5010b2'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/img_Created_cursor-pointer'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Job Details Work Stages Defect Rectific_a011ce_1'))
