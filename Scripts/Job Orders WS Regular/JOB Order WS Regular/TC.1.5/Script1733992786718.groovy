...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Work Stages Defect Rectification Record_8d9471'))

WebUI.click(findTestObject('Button/Page_Workchestra/button_Redeclare Compliance'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Work Stages Defect Rectification Record_8d9471_1'))
