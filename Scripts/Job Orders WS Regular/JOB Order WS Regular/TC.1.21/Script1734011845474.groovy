...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Work Stages Defect Rectification Record_01e1f2'))
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_-'))
