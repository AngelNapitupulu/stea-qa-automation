...
WebUI.verifyElementText(findTestObject('Page_Workchestra/div_Job orders'), 'Job orders')

WebUI.delay(5)

//WebUI.verifyElementText(findTestObject('Object Repository/Page_Workchestra/div_Job ordersAny Status Not Started  Job S_b01307'), 
// 'Job orders')
WebUI.closeBrowser()
