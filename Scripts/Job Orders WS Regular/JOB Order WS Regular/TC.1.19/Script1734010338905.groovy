...
WebUI.click(findTestObject('Button/Page_Workchestra/Hidden Damage Inspection/Page_Workchestra/Page_Workchestra/div_Job Details Work Stages Defect Rectification RecordCRR FormsCompliance'))

WebUI.click(findTestObject('Button/Page_Workchestra/Hidden Damage Inspection/Page_Workchestra/span_In Progress'))
