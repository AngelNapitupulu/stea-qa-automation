...
WebUI.navigateToUrl('https://workchestra-moonlay.southeastasia.cloudapp.azure.com:4200/eworkbag/job/313')
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Update Reference Update reference under_98c2c9'))

WebUI.setText(findTestObject('Object Repository/Page_Workchestra/input_checkbox'), '3834000-50')
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Confirm and Sign Amendment Please place_de085e'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/img_Created_cursor-pointer'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Workchestra/span_Amended by WS'), 10)
