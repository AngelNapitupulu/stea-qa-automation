...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Add Defect Rectification'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Add Defect Rectification Add defect rec_5ae35c'))
