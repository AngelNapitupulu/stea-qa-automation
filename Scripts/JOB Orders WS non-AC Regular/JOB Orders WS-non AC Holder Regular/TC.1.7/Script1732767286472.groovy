...
WebUI.navigateToUrl('https://workchestra-moonlay.southeastasia.cloudapp.azure.com:4200/eworkbag/job/318')
...
WebUI.verifyElementText(findTestObject('Button/Page_Workchestra/span_In Progress'), 'In Progress')
