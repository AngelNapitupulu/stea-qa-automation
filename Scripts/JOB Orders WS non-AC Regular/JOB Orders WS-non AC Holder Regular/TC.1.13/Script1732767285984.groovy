...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/a_Last'))
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/button_WS(Non AC Holder)'))
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/input_checkbox'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/label_DGCA, India (5-24602016-AI(2))'))
...
WebUI.setText(findTestObject('Object Repository/Page_Workchestra/input_Page Reference_workstageReferenceInput'), '3834000-21')
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/tab_Work StageReferenceStatusAction1. Preli_471a9c'))
