...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Submit to Release Signatory  Submit Har_18d2cd'))
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/button_Declare Tool Tagging'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Work Stages Defect Rectification Record_04ac9e_1'))
