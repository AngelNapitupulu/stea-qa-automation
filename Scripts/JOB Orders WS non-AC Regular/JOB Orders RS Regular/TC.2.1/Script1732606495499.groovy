...
WebUI.navigateToUrl('https://workchestra-moonlay.southeastasia.cloudapp.azure.com:4200/eworkbag/job/240')

WebUI.click(findTestObject('Object Repository/Page_ST Engineering Aerospace/form_Log in'))
...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/td_1. Preliminary Inspection'))
