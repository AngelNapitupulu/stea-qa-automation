...
WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Confirm and Approve Job Order Please pl_3ec069'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/img_Created_cursor-pointer'))

WebUI.click(findTestObject('Object Repository/Page_Workchestra/div_Job No.  74016580000298Pending ARC Gene_6a1d4d'))
